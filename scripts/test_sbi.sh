...
# CUDA_VISIBLE_DEVICES=0 python scripts/test.py --cfg configs/spatial/vit_sbi_large.yaml \
#                                               -i samples/debugs/affine_f_2883.jpg
...
# CUDA_VISIBLE_DEVICES=0 python scripts/test.py --cfg configs/spatial/swin_sbi_tiny.yaml \
#                                               -i samples/debugs/affine_f_2883.jpg

# CUDA_VISIBLE_DEVICES=0 python scripts/test.py --cfg configs/temporal/FakeSFormer_base.yaml \
#                                               -i samples/debugs/affine_f_2883.jpg                                              

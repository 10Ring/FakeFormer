...
This is an official implementation for FakeFormer!

Contact: XXX. Any questions or discusses are welcomed!

![alt text](./demo/fakeformer_performance.png?raw=true)


## Attention
> ⚠️ *This project is in the process of the license registration. Therefore, within scope of the CVPR2025 submission, it is **only** used with **limited access** to the **assigned reviewers** and **individuals involved in the review process**. The source codes should **NOT** be **distributed** and **disclosed** to other parties.*
...
## Pre-trained Models
* 📌 *The pre-trained weights of FakeFormer and FakeSwin using BI and SBI will be released soon!*
